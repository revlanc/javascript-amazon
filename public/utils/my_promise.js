...
// async success test
const myFirstPromise1 = new MyPromise((resolve, reject) => {
  setTimeout(() => {
...
// async failure test
const myFirstPromise2 = new MyPromise((resolve, reject) => {
  const a = 1 + 2;
...
// sync success test
const myFirstPromise3 = new MyPromise((resolve, reject) => {
  const a = 1 + 1;
